...
if [[ "$RUN_LOCAL_APTGET" = true ]]; then
    ...
    export PYTHONPATH=/opt/intel/dlstreamer/gstreamer/lib/python3/dist-packages:/home/runner/edge-ai-libraries-repo/libraries/dl-streamer/python:/opt/intel/dlstreamer/gstreamer/lib/python3/dist-packages:
    export PATH=$HOME_DIR/.virtualenvs/dlstreamerbin:/opt/intel/dlstreamer/gstreamer/bin:/opt/intel/dlstreamer/bin:$PATH
